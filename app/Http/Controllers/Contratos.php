    ...
    public function addContrato(Request $request)
    {
        ...
        if ($request->clienteNuevo == true) {
            ...
            $contrato = DB::table('contratos')->insertGetId([
                ...
                'fecha_inter' => $request->fecha_inter,
                'dias_inter' => $request->dias_inter,
                'mes_inter' => $request->mes_inter,
                'year_inter' => $request->year_inter,

                'fecha_contra' => $request->fecha_contra,
                'dias_contra' => $request->dias_contra,
                'mes_contra' => $request->mes_contra,
                'year_contra' => $request->year_contra,
                ...
                'x' => $request->x,
                'y' => $request->y,
                'rpu' => str_replace(' ', '', $request->rpu),
                'rmu' => str_replace(' ', '', $request->rmu),
                'n_cuenta' => $request->n_cuenta,
                'tension' => $request->tension,
                'capacidad' => $request->capacidad,
                'capacidad_incrementar' => $request->capacidad_incrementar,
                'capacidad_incrementar_opcional' => $request->capacidad_incrementar_opcional,
                'tension_interconexion' => $request->voltaje,
